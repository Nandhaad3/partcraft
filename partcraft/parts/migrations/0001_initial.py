# Generated by Django 4.1.13 on 2024-09-19 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.costcategory')),
            ],
        ),
        migrations.CreateModel(
            name='CurrencyCode',
        ...
        migrations.CreateModel(
            name='SellerPreferces',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('seller', models.ManyToManyField(to='parts.seller')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='seller',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.sellergroup'),
        ),
        migrations.CreateModel(
            name='RelatedProduct',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='parts.choice')),
        ...
        migrations.AddField(
            ...
            name='sectioncode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.section'),
        ),
        migrations.AddField(
            model_name='productattribute',
            name='tabcode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.tab'),
        ),
        migrations.CreateModel(
            name='Product_cost',
            fields=[
                ...
                ('product_currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.currencycode')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.product')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderstatus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.orderstatus')),
            ],
        ),
        migrations.CreateModel(
            name='orderitems',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='parts.currencycode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ID', models.CharField(max_length=255, primary_key=True, serialize=False)),
                ('choice_name', models.ManyToManyField(to='parts.choice_name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='parts.categorys')),
            ],
        ),
        migrations.CreateModel(
            name='carts',
